...
cd ../Infrastructure.Middleware.Core
dotnet pack --output ../release 

cd ../release 

nuget push Infrastructure.Common.Core.1.0.0.nupkg 40F15705-8EE5-418F-9FD2-123094E212CB -source http://localhost:9001
...
nuget push Infrastructure.Middleware.Core.1.0.0.nupkg 40F15705-8EE5-418F-9FD2-123094E212CB -source http://localhost:9001