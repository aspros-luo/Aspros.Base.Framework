...
namespace Infrastructure.Interfaces.Core
{
    public class WorkContext : IWorkContext
    {
        ...
        private async Task<JObject> GetUserData()
        {
            ...
            await _distributedCache.SetAsync(userKey, Encoding.UTF8.GetBytes(userDataString),
                new DistributedCacheEntryOptions().SetAbsoluteExpiration(DateTimeOffset.Now.AddHours(5)));
            return obj;
        }
    }
}